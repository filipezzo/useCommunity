		...
		<header className="sticky gap-4 border-b border-neutral-400 p-4 ">
			<div className=" mx-auto flex w-full max-w-7xl items-center justify-between ">
				...
				<div className="flex items-center gap-5">
					...
					<button className="rounded-md border border-blue-500/70  px-4 py-2 text-blue-500/70 duration-300 focus-within:bg-blue-500/70 focus-within:text-white hover:bg-blue-500/70 hover:text-white">
						Criar conta
					</button>
				</div>
			</div>
